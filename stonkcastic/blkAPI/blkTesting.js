...
let Aladdin = new blk.API();
// Aladdin.securityData({
//     fullUrl :  "https://www.blackrock.com/tools/hackathon/security-data?identifiers=BLK",
//     parameters : {
//     identifiers :  "BLK"
//     },
//     url :  "/tools/hackathon/security-data"
// });
const URL = 'https://www.blackrock.com/tools/hackathon/security-data?identifiers=BLK';
Axios.get(URL)
.then((result) => {
    console.log(result);
}).catch((err) => {
